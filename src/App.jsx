...
function App() {
  ...
  return (
    <div className="App">
      ...
      <button onClick={downloadsTodo} style={{padding: '10px', backgroundColor: 'green', color: 'white', border: 'none', borderRadius: '10px', cursor: 'pointer', marginTop: '10px'}}>Сохранить</button>
    </div>
  );
}
